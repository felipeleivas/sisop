...
void* funcTest0(void *i) {
  ...
  printf("2 - func0: Vou suspender a thread id1 com tid = %d\n, que deve ir para o estado apto-suspenso...\n", tidThread1);
  csuspend(tidThread1);
  printf("3 - func0: Vou passar a vez para a proxima thread, que deve ser a id2...\n");
  cyield();
  printf("7 - func0: Voltei!\n");
  printf("8 - func0: Vou acabar. Logo, a thread id1 deve assumir...\n");
  return 0;
}

void* funcTest1(void *i) {
  printf("9 - func1: Entrei na thread id1, como esperado!\n");
  printf("10 - func1: Vou acabar.\n");
  return 0;
}

void* funcTest2(void *i) {
  printf("4 - func2: Entrei na thread id2...\n");
  printf("5 - func2: Vou resumir a thread id1 com tid = %d\n, que deve ir para o estado apto...\n", tidThread1);
  cresume(tidThread1);
  printf("6 - func2: Vou acabar. Logo, a thread id0 deve voltar...\n");
  return 0;
}
