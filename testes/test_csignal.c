...
void* funcTest0(void *i) {
  ...
  cyield();
  printf("13 - func0: Voltei!\n");
  printf("14 - func0: Vou dar csignal no semaforo 1. Logo, devo liberar o recurso para o proximo na fila...\n");
  csignal(&semaforo_1);
  printf("15 - func0: Vou dar mais um csignal no semaforo 1. Logo, devo liberar mais um recurso...\n");
  csignal(&semaforo_1);
  printf("16 - func0: Vou acabar!\n");
...
void* funcTest2(void *i) {
  printf("11 - func2: Entrei na thread id2!\n");
  printf("12 - func2: Vou dar cwait no semaforo 1. Logo, devo ir para o bloqueado..\n");
  cwait(&semaforo_1);
  printf("19 - func2: Voltei!\n");
  printf("20 - func2: Vou acabar!\n");

  return 0;
}

int main(int argc, char **argv) {
  int recursos_1 = 1, id0 = 0, id1 = 0, id2 = 0;
  id1++;
  id2++;
